...
class AdjustmentBar(QWidget):
    ...
    def __init__(self, parent=None):
        ...
        # Deliberately NOT connected to editingFinished: applying the range
        # while only one of the two boxes had been typed produced a
        # half-finished range (e.g. 0 -> old value) and made the control
        # feel wrong. Both values are read together when Apply is pressed.
        self._left_spin.returnPressed = None
        ...
        self._right_spin.returnPressed = None
