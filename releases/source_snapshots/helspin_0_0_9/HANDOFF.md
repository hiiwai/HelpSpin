...
Version at time of writing: **0.0.8**. Read this before changing anything;
...
| Issue | Status |
|---|---|
| **2D spectra are not displayed** | Not implemented. Dropping one reports it rather than failing silently. This is the main remaining milestone and the trigger for `0.1.0`. |
| Export (SVG/EPS/PS/TIFF/JPEG) | Not implemented. |
| Undo/redo | Not implemented. |
| TopSpin `xcpy` bridge | Not implemented. |
| Difference spectra | Domain logic exists (`overlay.py`), no UI. |
