...
def test_expanding_a_filtered_sample_still_shows_its_experiments(tmp_path):
    ...
    """
    root = tmp_path / "nmr"
    make_expno(root / "260727_Rifampicin_50uM", 1)
    make_expno(root / "260727_Rifampicin_50uM", 11)
    ...
    assert proxy.data(sample) == "260727_Rifampicin_50uM"
    names = {
